      ...
      <div className="container mx-auto px-2 md:px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl bg-gray-100 dark:bg-gray-800 border border-amber-200 dark:border-gray-800 p-6 space-y-4">
              <Skeleton className="h-6 w-32 bg-gray-200 dark:bg-gray-700" />
              <Skeleton className="h-20 w-full rounded-lg bg-gray-200 dark:bg-gray-700" />
            ...
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="rounded-2xl bg-gray-100 dark:bg-gray-800 border border-amber-200 dark:border-amber-800 p-4 space-y-4"
              >
                <div className="flex flex-col sm:flex-row gap-4">
                  <Skeleton className="w-full sm:w-1/3 h-44 rounded-xl bg-gray-200 dark:bg-gray-700" />
            ...
            <div className="rounded-2xl bg-gray-100 dark:bg-gray-800 border border-amber-200 dark:border-gray-800 p-4 space-y-4">
              <Skeleton className="h-5 w-32 bg-gray-200 dark:bg-gray-700" />
              <div className="flex gap-4">
                <Skeleton className="flex-1 h-10 rounded-md bg-gray-200 dark:bg-gray-700" />
                <Skeleton className="w-24 h-10 rounded-md bg-green-200 dark:bg-green-700" />
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 max-w-sm rounded-2xl shadow-xl border border-amber-200 dark:border-gray-800 bg-white/70 dark:bg-gray-900/80 backdrop-blur-lg p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Skeleton className="h-12 w-full rounded-xl bg-amber-200 dark:bg-amber-700" />
              </div>
            </div>
          </div>
        </div>
