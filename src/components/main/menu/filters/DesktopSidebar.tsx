          ...
          <div>
            ...
            <div className="space-y-4">
              <Slider
                ...
                className="w-full"
                onValueChange={(val) =>
                  updateFilter({ minPrice: val[0], maxPrice: val[1], page: 1 })
                }
                onValueCommit={(val) =>
                  updateFilter({ minPrice: val[0], maxPrice: val[1], page: 1 })
                }
              ...
              <div className="flex justify-between text-sm font-medium text-gray-700 dark:text-gray-300">
                <span>{formatCurrency(filters?.maxPrice)} تومان</span>
                <span>{formatCurrency(filters?.minPrice)} تومان</span>
              </div>
              ...
              <PriceInputs
                ...
                onMinPriceChange={(val) =>
                  updateFilter({ minPrice: val, page: 1 })
                }
                onMaxPriceChange={(val) =>
                  updateFilter({ maxPrice: val, page: 1 })
                }
              ...
              {[
                ...
                >
                  <div
                    className={cn(
                      "p-2 rounded-lg",
                      option?.value === "true" ? "bg-green-500" : "bg-blue-500"
                    )}
                  ></div>
