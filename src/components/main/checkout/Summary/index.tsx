...
import { Truck, CreditCard, X, MapPin, AlertCircle } from "lucide-react";
              ...
              <div className="space-y-4">
                ...
                >
                  {renderCompleteOrderButton(
                    "w-full py-6 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-lg shadow-lg group disabled:opacity-50 disabled:cursor-not-allowed"
                  )}
                </MotionDiv>
              </div>
            </div>
