...
export const aboutUsMetadata: Metadata = generatePageMetadata({
  ...
  description:
    "از سال ۱۳۹۵، کافینو به عنوان یکی از پیشگامان صنعت کافه‌داری در گیلان، تجربه‌ای منحصر به فرد از طعم‌های اصیل و محیطی گرم و دوستانه ارائه می‌دهد. با تیم متخصص و ارزش‌های منحصر به فرد.",
  path: "/about-us",
  images: [
    {
